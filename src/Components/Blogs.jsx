  ...
  return (
    <div>
      ...
      <div className="cards lg:p-0 p-4 lg:flex lg:w-[100%] md:w-[70%] mx-auto justify-center mt-20 gap-[50px]">
        <div class="block lg:w-[20%] text-white rounded-3xl bg-[#123734]/50 p-6 shadow-secondary-1 bg-[url('https://framerusercontent.com/images/GgKuYg1HHQ3WZT2x755JpKYeBQ.png?scale-down-to=1024')] hover:border-[0.1px] border-[#e8fce8] hover:text-[#e8fce8] hover:transition duration-150 hover:scale-[1.01]">
        ...
        <div class="block lg:w-[20%] text-white lg:my-0 lg:my-0 my-5 rounded-3xl bg-[#123734]/50 p-6 shadow-secondary-1 bg-[url('https://framerusercontent.com/images/GgKuYg1HHQ3WZT2x755JpKYeBQ.png?scale-down-to=1024')] hover:border-[0.1px] border-[#e8fce8] hover:text-[#e8fce8] hover:transition duration-150 hover:scale-[1.01]">
