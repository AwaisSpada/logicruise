...
const Choose = () => {
    const [style, setStyle] = useState("bg-[#36668b] p-10 rounded-tr-3xl rounded-b-3xl");
    ...
    switch (index) {
      case 0:
        setStyle("bg-[#36668b] p-10 rounded-tr-3xl rounded-br-3xl rounded-bl-3xl");
        break;
      case 1:
        setStyle("bg-[#36668b] p-10 rounded-3xl");
        break;
      case 2:
        setStyle("bg-[#36668b] p-10 rounded-tl-3xl rounded-br-3xl rounded-bl-3xl");
        break;
      default:
        break;
    }
    ...
    <div id='choose' ref={ref} className='bg-[black]/30 mt-20 opacity-0 p-5 pb-28'>
      <div className='lg:flex md:flex md:py-28 md:w-[100%] lg:py-36 lg:w-[80%] lg:gap-10 mx-auto text-white justify-center'>
        <div className="left md:mt-[-80px] lg:mt-[-100px]">
            <h1 id='choose1' className='text-5xl font-bold opacity-0 text-[#36668b]'>Why should you choose Spadasoft?</h1>
            ...
            <Link to='contact' smooth={true} duration={1500}><button id='choose3' className='bg-[#36668b] transition py-4 px-10 rounded-full opacity-0'>Contact Now</button></Link>
        </div>
        ...
        <Link
          ...
          className={`py-5 rounded-t-2xl px-9 lg:px-10 cursor-pointer ${
            activeIndex === index ? 'bg-[#36668b]' : ''
          }`}
        >
          {label}
        </Link>
